...
public class SpeakFloatLeftView extends AbsFloatView implements ISpeakFloatViewControl {
    private static final String TAG = SpeakFloatLeftView.class.getSimpleName();
    ...
    public View onCreateView(Context context, FrameLayout rootView) {
        return LayoutInflater.from(context).inflate(R.layout.include_unfold_speak_leftfloat_view, rootView, false);
    }
    ...
    private void startUnfoldAnim() {
        ...
        Log.d(TAG, "startUnfoldAnim: startleftXX : " + startLeft2);
